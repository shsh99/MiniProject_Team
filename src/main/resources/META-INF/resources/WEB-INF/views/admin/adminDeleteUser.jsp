...
<body>
    ...
    <!-- 삭제 폼 -->
    <form id="deleteForm" action="${pageContext.request.contextPath}/adminDeleteUser" method="post" onsubmit="return clearErrorMessage();">
        <label for="id">사용자 ID:</label>
        <input type="text" id="id" name="id" value="${user.id}" readonly="readonly"><br><br>
